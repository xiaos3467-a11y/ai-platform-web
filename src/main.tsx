...
/**
 * Apple-inspired design tokens — dark mode default
 * Deep blacks, frosted glass surfaces, precise typography.
 * All colors are set EXPLICITLY (no algorithm) for full control.
 */
const darkTokens = {
  token: {
    // ─── Core palette ──────────────────────────────────────────
...
/* Light theme — same structure, for toggle support */
const lightTokens = {
  token: {
    colorPrimary: '#0071e3',
    colorSuccess: '#34c759',
...
// Export for use in other components that need to know the theme
...
ReactDOM.createRoot(document.getElementById('root')!).render(
  <React.StrictMode>
    <ConfigProvider locale={zhCN} theme={darkTokens}>
      <AntApp>
        <BrowserRouter>
          <App />
        </BrowserRouter>
